...
import 'package:flutter_look_good_assignment/Orders/placeOrderPayment.dart';
...
import 'package:flutter_look_good_assignment/Widgets/wideButton.dart';

import 'package:flutter_look_good_assignment/counters/changeAddresss.dart';
             ...
             Consumer<AddressChanger>(builder: (context, address, c){
               return Flexible(
                   child: StreamBuilder<QuerySnapshot>(
                     stream: EcomApp.firestore
                         .collection(EcomApp.collectionUser)
                         .document(EcomApp.sharedPreferences.getString(EcomApp.userUID))
                         .collection(EcomApp.subCollectionAddress).snapshots(),
